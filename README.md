...
[![Maven Central](https://img.shields.io/badge/maven--central-2.17.7-blue.svg)](https://repo1.maven.org/maven2/com/github/plokhotnyuk/jsoniter-scala/)
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.17.7" % "compile-internal"
)
```
