...
[![Scaladex](https://img.shields.io/badge/macros-0.6.1-blue.svg?)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/macros)
...
[Latest results of benchmarks](http://plokhotnyuk.github.io/jsoniter-scala/) for JDK 8 & JDK 9 on the 
following environment: Intel® Core™ i7-7700HQ CPU @ 2.8GHz (max 3.8GHz), RAM 16Gb DDR4-2400, Ubuntu 16.04, 
Linux notebook 4.13.0-32-generic, Oracle JDK builds 1.8.0_161-b12 & 9.0.4+11 64-bit
...
- Codecs can be generated for primitives, boxed primitives, enums, `String`, `BigInt`, `BigDecimal`, `Option`, tuples,
  `java.util.UUID`,  Scala collections, arrays, module classes, value classes and case classes with values/fields having
  any of types listed here 
...
- Types that supported as map keys are primitives, boxed primitives, enums, `String`, `BigInt`, `BigDecimal`, 
  `java.util.UUID` and value classes for any of them 
...
```sbt
libraryDependencies += "com.github.plokhotnyuk.jsoniter-scala" %% "macros" % "0.6.1"
```
