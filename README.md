...
[![Scaladex](https://img.shields.io/badge/jsoniter--scala--macros-0.46.0-blue.svg)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/jsoniter-scala-macros)
...
versions of Open JDK 8/11/12, Oracle JDK 8/11/12, and GraalVM CE/EE
...
- Releases for different Scala versions: 2.11, 2.12, 2.13.0-M5, 2.13.0-RC1  
...
libraryDependencies ++= Seq(
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "0.46.0" % Compile, 
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "0.46.0" % Provided // required only in compile-time
)
```
