...
[![Scaladex](https://img.shields.io/badge/jsoniter--scala--macros-0.44.4-blue.svg)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/jsoniter-scala-macros)
...
RAM 16Gb DDR4-2400, Ubuntu 18.04, latest versions of Open JDK 8/11/12, Oracle JDK 8/11/12, and GraalVM CE/EE
...
libraryDependencies ++= Seq(
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "0.44.4" % Compile, 
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "0.44.4" % Provided // required only in compile-time
)
```
