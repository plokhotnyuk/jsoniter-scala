...
[![Scaladex](https://img.shields.io/badge/macros-0.28.1-blue.svg?)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/macros)
...
(its Java API only) libraries using different JDK and GraalVM versions on the following environment: 
