...
[![Maven Central](https://img.shields.io/badge/maven--central-2.38.4-blue.svg)](https://repo1.maven.org/maven2/com/github/plokhotnyuk/jsoniter-scala/)
...
libary:
```scala
//> using dep "com.github.plokhotnyuk.jsoniter-scala::jsoniter-scala-core::2.38.4"
//> using compileOnly.dep "com.github.plokhotnyuk.jsoniter-scala::jsoniter-scala-macros::2.38.4"
```
...
```sh
sbt -java-home /usr/lib/jvm/jdk-11 ++2.13.17 clean coverage jsoniter-scala-coreJVM/test jsoniter-scala-circeJVM/test jsoniter-scala-macrosJVM/test jsoniter-scala-benchmarkJVM/test coverageReport
