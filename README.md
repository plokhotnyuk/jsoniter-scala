...
[![Maven Central](https://img.shields.io/badge/maven--central-2.2.6-blue.svg)](https://search.maven.org/search?q=jsoniter-scala-macros)
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.2.6" % "compile-internal" // or "provided", but it is required only in compile-time
)
```
