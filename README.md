...
[![Maven Central](https://img.shields.io/badge/maven--central-0.49.0-blue.svg)](https://search.maven.org/search?q=jsoniter-scala-macros)
...
- Releases for different Scala versions: 2.11, 2.12, 2.13.0-RC1, 2.13.0-RC2, 2.13.0-RC3  
...
libraryDependencies ++= Seq(
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "0.49.0" % Compile, 
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "0.49.0" % Provided // required only in compile-time
)
```
