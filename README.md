...
[![Maven Central](https://img.shields.io/badge/maven--central-2.13.5-blue.svg)](https://search.maven.org/search?q=jsoniter-scala-macros)
...
(max 4.9GHz), RAM 32Gb DDR4-3200, Ubuntu 21.10, and latest versions of Azul Zulu 11/17, OpenJDK 19[*](https://docs.google.com/spreadsheets/d/1IxIvLoLlLb0bxUaRgSsaaRuXV0RUQ3I04vFqhDc2Bt8/edit?usp=sharing), 
...
The [v2.13.5](https://github.com/plokhotnyuk/jsoniter-scala/releases/tag/v2.13.5) is the last release that supports 
JDK 8+ and native image compilation with earlier versions of GraalVM.
