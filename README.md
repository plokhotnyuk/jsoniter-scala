...
[![Maven Central](https://img.shields.io/badge/maven--central-2.1.4-blue.svg)](https://search.maven.org/search?q=jsoniter-scala-macros)
...
libraryDependencies ++= Seq(
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core"   % "2.1.4" % Compile,
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.1.4" % Provided // required only in compile-time
)
```
