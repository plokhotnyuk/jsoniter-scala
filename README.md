...
[![Maven Central](https://img.shields.io/badge/maven--central-2.23.5-blue.svg)](https://repo1.maven.org/maven2/com/github/plokhotnyuk/jsoniter-scala/)
...
GraalVM Community JDK 17/21, and GraalVM JDK 17/20.
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.23.5" % "compile-internal"
)
```
