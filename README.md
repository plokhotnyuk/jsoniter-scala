...
[![Maven Central](https://img.shields.io/badge/maven--central-2.24.0-blue.svg)](https://repo1.maven.org/maven2/com/github/plokhotnyuk/jsoniter-scala/)
...
(max 5.8GHz, performance-cores only), RAM 64Gb DDR5-4800, Ubuntu 23.04 (Linux 6.2), and latest versions of JDK 17/21[*](https://docs.google.com/spreadsheets/d/1IxIvLoLlLb0bxUaRgSsaaRuXV0RUQ3I04vFqhDc2Bt8/edit?usp=sharing),
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core"   % "2.24.0",
  // Use the "provided" scope instead when the "compile-internal" scope is not supported  
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.24.0" % "compile-internal"
)
```
