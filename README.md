...
[![Maven Central](https://img.shields.io/badge/maven--central-2.38.9-blue.svg)](https://repo1.maven.org/maven2/com/github/plokhotnyuk/jsoniter-scala/)
...
compiled by by Scala 3.7.4 and Scala.js 1.20.2 to ES 2021 with GCC v20220202 optimizations applied on
...
//> using compileOnly.dep "com.github.plokhotnyuk.jsoniter-scala::jsoniter-scala-macros::2.38.9"
```
