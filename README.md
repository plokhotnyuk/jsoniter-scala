...
[![Scaladex](https://img.shields.io/badge/jsoniter--scala--macros-0.46.4-blue.svg)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/jsoniter-scala-macros)
...
versions of Open JDK 8/11/12 and GraalVM CE/EE
...
libraryDependencies ++= Seq(
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "0.46.4" % Compile, 
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "0.46.4" % Provided // required only in compile-time
)
```
