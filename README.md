...
[![Scaladex](https://img.shields.io/badge/macros-0.21.3-blue.svg?)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/macros)
...
```sbt
libraryDependencies += "com.github.plokhotnyuk.jsoniter-scala" %% "macros" % "0.21.3"
```
