...
[![Scaladex](https://img.shields.io/badge/jsoniter--scala--macros-0.37.3-blue.svg)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/jsoniter-scala-macros)
...
libraryDependencies ++= Seq(
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "0.37.3" % Compile, 
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "0.37.3" % Provided // required only in compile-time
)
```
