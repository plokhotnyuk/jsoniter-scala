...
[![Maven Central](https://img.shields.io/badge/maven--central-2.38.13-blue.svg)](https://repo1.maven.org/maven2/com/github/plokhotnyuk/jsoniter-scala/)
...
libraries complied by Scala 3.8.4-RC3 with `-opt -opt-inline:**,!java.**` options for optimization and inlining
...
//> using compileOnly.dep "com.github.plokhotnyuk.jsoniter-scala::jsoniter-scala-macros::2.38.13"
```
