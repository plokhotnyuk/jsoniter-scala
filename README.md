...
[![Known vulnerabilities](https://snyk.io/test/github/plokhotnyuk/jsoniter-scala/badge.svg)](https://snyk.io/test/github/plokhotnyuk/jsoniter-scala) 
...
[![Scaladex](https://img.shields.io/badge/jsoniter--scala--macros-0.36.5-blue.svg)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/jsoniter-scala-macros)
...
versions of Open JDK 8, Oracle JDK 8, Open JDK 11, Oracle JDK 11, Open JDK 11 + Graal JIT, Oracle JDK 11 + Graal JIT, 
and GraalVM CE/EE
...
libraryDependencies ++= Seq(
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core" % "0.36.5" % Compile, 
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "0.36.5" % Provided // required only in compile-time
)
```
