...
[![Maven Central](https://img.shields.io/badge/maven--central-1.2.0-blue.svg)](https://search.maven.org/search?q=jsoniter-scala-macros)
...
libraryDependencies ++= Seq(
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-core"   % "1.2.0" % Compile,
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "1.2.0" % Provided // required only in compile-time
)
```
