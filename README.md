...
[![Maven Central](https://img.shields.io/badge/maven--central-2.6.1-blue.svg)](https://search.maven.org/search?q=jsoniter-scala-macros)
...
and Graal JIT compilers, GraalVM 20.3 CE for Java 8/11 (dev build) and GraalVM 20.2 EE for Java 8/11.
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.6.1" % "compile-internal" // or "provided", but it is required only in compile-time
)
```
