...
[![Scaladex](https://img.shields.io/badge/macros-0.29.3-blue.svg?)](https://index.scala-lang.org/plokhotnyuk/jsoniter-scala/macros)
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "0.29.3" % Provided // required only in compile-time
)
```
