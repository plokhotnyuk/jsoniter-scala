...
[![Maven Central](https://img.shields.io/badge/maven--central-2.7.3-blue.svg)](https://search.maven.org/search?q=jsoniter-scala-macros)
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "2.7.3" % "compile-internal"
)
```
