...
[![Maven Central](https://img.shields.io/badge/maven--central-0.50.0-blue.svg)](https://search.maven.org/search?q=jsoniter-scala-macros)
...
libraryDependencies ++= Seq(
  ...
  "com.github.plokhotnyuk.jsoniter-scala" %% "jsoniter-scala-macros" % "0.50.0" % Provided // required only in compile-time
)
```
