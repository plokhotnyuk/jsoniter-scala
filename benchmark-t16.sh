...
sbt -batch -java-home /usr/lib/jvm/zulu-17 clean 'jsoniter-scala-benchmarkJVM/jmh:run -jvm /usr/lib/jvm/openjdk-21/bin/java -t 16 -p size=128 -prof gc -rf json -rff openjdk-21-t16.json .*' 2>&1 | tee openjdk-21-t16.txt
