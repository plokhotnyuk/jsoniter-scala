...
sbt -java-home /usr/lib/jvm/java-8-oracle -no-colors ++2.12.6 clean 'benchmark/jmh:run -p size=128 -jvm /usr/lib/jvm/graalvm-ee-1.0.0-rc1/bin/java -prof gc -rf json -rff graalvmee1.json .*Benchmark.*' >graalvmee1.txt
sbt -java-home /usr/lib/jvm/java-8-oracle -no-colors ++2.12.6 clean 'benchmark/jmh:run -p size=128 -jvm /usr/lib/jvm/graalvm-ce-1.0.0-rc1/bin/java -prof gc -rf json -rff graalvmce1.json .*Benchmark.*' >graalvmce1.txt
