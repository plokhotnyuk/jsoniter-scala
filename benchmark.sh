...
/usr/lib/jvm/graalvm-community-jdk-24/bin/java -jar jsoniter-scala-benchmark/jvm/target/scala-3.6.3/benchmarks.jar -jvmArgsAppend "-Djmh.executor=FJP" -p size=128 -prof gc -rf json -rff graalvm-community-jdk-24.json .* 2>&1 | tee graalvm-community-jdk-24.txt
