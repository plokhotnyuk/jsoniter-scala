...
sbt -batch -java-home /usr/lib/jvm/graalvm-community-jdk-20 clean 'jsoniter-scala-benchmarkJVM/jmh:run -p size=128 -prof gc -rf json -rff graalvm-community-jdk-20.json .*' 2>&1 | tee graalvm-community-jdk-20.txt
