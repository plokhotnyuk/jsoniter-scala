...
sbt -batch -java-home /usr/lib/jvm/openjdk-21 clean 'jsoniter-scala-benchmarkJVM/jmh:run -p size=128 -prof gc -rf json -rff openjdk-21.json .*' 2>&1 | tee openjdk-21.txt
