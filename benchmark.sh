...
sbt -batch -java-home /usr/lib/jvm/graalvm-community-jdk-23 clean 'jsoniter-scala-benchmarkJVM/jmh:run -jvmArgsAppend "-Djmh.executor=FJP" -p size=128 -prof gc -rf json -rff graalvm-community-jdk-23.json .*' 2>&1 | tee graalvm-community-jdk-23.txt
