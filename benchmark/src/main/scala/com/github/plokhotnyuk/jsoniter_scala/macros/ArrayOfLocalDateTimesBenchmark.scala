...
class ArrayOfLocalDateTimesBenchmark extends CommonParams {
  ...
  @Benchmark
  def readJsoniterScala(): Array[LocalDateTime] = JsonReader.read(localDateTimeArrayCodec, jsonBytes)
...
*/
  @Benchmark
  def writeJsoniterScala(): Array[Byte] = JsonWriter.write(localDateTimeArrayCodec, obj)

  @Benchmark
  def writeJsoniterScalaPrealloc(): Int = JsonWriter.write(localDateTimeArrayCodec, obj, preallocatedBuf, 0)
