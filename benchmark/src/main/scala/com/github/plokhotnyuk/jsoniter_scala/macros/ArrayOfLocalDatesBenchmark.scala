...
class ArrayOfLocalDatesBenchmark extends CommonParams {
  ...
  @Benchmark
  def readJsoniterScala(): Array[LocalDate] = JsonReader.read(localDateArrayCodec, jsonBytes)
...
*/
  @Benchmark
  def writeJsoniterScala(): Array[Byte] = JsonWriter.write(localDateArrayCodec, obj)

  @Benchmark
  def writeJsoniterScalaPrealloc(): Int = JsonWriter.write(localDateArrayCodec, obj, preallocatedBuf, 0)
