...
class ArrayOfUUIDsBenchmark extends CommonParams {
  ...
  @Benchmark
  def readJsoniterScala(): Array[UUID] = JsonReader.read(uuidArrayCodec, jsonBytes)
  ...
  @Benchmark
  def writeJsoniterScala(): Array[Byte] = JsonWriter.write(uuidArrayCodec, obj)

  @Benchmark
  def writeJsoniterScalaPrealloc(): Int = JsonWriter.write(uuidArrayCodec, obj, preallocatedBuf, 0)
