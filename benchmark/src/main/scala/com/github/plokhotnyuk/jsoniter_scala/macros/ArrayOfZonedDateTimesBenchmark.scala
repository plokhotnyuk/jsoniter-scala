...
*/
  @Benchmark
  def readJsoniterScala(): Array[ZonedDateTime] = JsonReader.read(zonedDateTimeArrayCodec, jsonBytes)
...
*/
  @Benchmark
  def writeJsoniterScala(): Array[Byte] = JsonWriter.write(zonedDateTimeArrayCodec, obj)

  @Benchmark
  def writeJsoniterScalaPrealloc(): Int = JsonWriter.write(zonedDateTimeArrayCodec, obj, preallocatedBuf, 0)
