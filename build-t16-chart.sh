...
echo 'var providedBenchmarks = ["JDK 17", "JDK 21", "JDK 24", "GraalVM CE JDK 21", "GraalVM CE JDK 24", "GraalVM JDK 17", "GraalVM JDK 21", "GraalVM JDK 22"];
