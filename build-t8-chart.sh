...
jq -c . < graalvm-community-jdk-17-t8.json
echo ', "GraalVM CE JDK 21":'
jq -c . < graalvm-community-jdk-21-t8.json
echo ', "GraalVM CE JDK 25":'
jq -c . < graalvm-community-jdk-25-t8.json
echo ', "GraalVM JDK 17":'
jq -c . < graalvm-jdk-17-t8.json
echo ', "GraalVM JDK 21":'
jq -c . < graalvm-jdk-21-t8.json
echo ', "GraalVM JDK 25":'
jq -c . < graalvm-jdk-25-t8.json
echo '}'
