...
lazy val `jsoniter-scala-benchmark` = crossProject(JVMPlatform, JSPlatform)
  ...
  .settings(noPublishSettings)
  .settings(
    crossScalaVersions := Seq("3.6.3", "2.13.16"),
    ...
    libraryDependencies ++= Seq(
      ...
      "dev.zio" %%% "zio-blocks" % "0.2.0+7213-d0cb03f9-SNAPSHOT",
      "dev.zio" %%% "zio-json" % "0.7.4+15-320a50fa-SNAPSHOT",
      "dev.zio" %%% "zio-schema-json" % "1.5.0+32-fc91dddf-SNAPSHOT",
