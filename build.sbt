...
lazy val `jsoniter-scala-benchmark` = crossProject(JVMPlatform, JSPlatform)
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.fasterxml.jackson.module" % "jackson-module-afterburner" % "2.13.0-rc1",
      ...
      "org.openjdk.jmh" % "jmh-generator-asm" % "1.33",
      "org.openjdk.jmh" % "jmh-generator-bytecode" % "1.33",
      "org.openjdk.jmh" % "jmh-generator-reflection" % "1.33",
      "org.scalatest" %%% "scalatest" % "3.2.9" % Test
    )
  )
