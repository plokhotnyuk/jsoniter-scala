...
lazy val `jsoniter-scala-benchmark` = crossProject(JVMPlatform, JSPlatform)
  ...
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "com.disneystreaming.smithy4s" %%% "smithy4s-json" % "0.18.12",
      ...
      "com.fasterxml.jackson.module" % "jackson-module-blackbird" % "2.16.2",
      ...
      case _ => Seq(
        ...
        "com.avsystem.commons" %%% "commons-core" % "2.14.0",
