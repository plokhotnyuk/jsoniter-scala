echo 'var providedBenchmarks = ["Corretto 8", "Corretto 11", "OpenJDK 18", "GraalVM CE 11", "GraalVM CE 16", "GraalVM EE 8", "GraalVM EE 11", "GraalVM EE 16"];
