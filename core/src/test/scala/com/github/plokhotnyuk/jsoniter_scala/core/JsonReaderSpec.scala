...
class JsonReaderSpec extends WordSpec with Matchers with PropertyChecks {
  ...
  "JsonReader.readDuration and JsonReader.readKeyAsDuration" should {
    ...
    "throw parsing exception for empty input and illegal or broken Duration string" in {
      ...
      checkError("\"P1DT2562047788015216H\"".getBytes, "illegal duration, offset: 0x00000015")
      checkError("\"P1DT-2562047788015216H\"".getBytes, "illegal duration, offset: 0x00000016")
      checkError("\"P1DT153722867280912931M\"".getBytes, "illegal duration, offset: 0x00000017")
      checkError("\"P1DT-153722867280912931M\"".getBytes, "illegal duration, offset: 0x00000018")
      checkError("\"P1DT9223372036854775808S\"".getBytes, "illegal duration, offset: 0x00000018")
      checkError("\"P1DT-9223372036854775809S\"".getBytes, "illegal duration, offset: 0x00000018")
      ...
      checkError("\"P1DT1H153722867280912931M\"".getBytes, "illegal duration, offset: 0x00000019")
      checkError("\"P1DT1H-153722867280912931M\"".getBytes, "illegal duration, offset: 0x0000001a")
      checkError("\"P1DT1H9223372036854775808S\"".getBytes, "illegal duration, offset: 0x0000001a")
      checkError("\"P1DT1H-9223372036854775809S\"".getBytes, "illegal duration, offset: 0x0000001a")
