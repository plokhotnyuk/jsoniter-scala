...
/usr/lib/jvm/jdk-27/bin/java -jar jvm/target/scala-2.13/benchmarks.jar -jvmArgsAppend "-XX:+UseCompactObjectHeaders" -t 16 -p size=512 -prof gc -rf json -rff jdk-27-t16.json .* 2>&1 | tee jdk-27-t16.txt
