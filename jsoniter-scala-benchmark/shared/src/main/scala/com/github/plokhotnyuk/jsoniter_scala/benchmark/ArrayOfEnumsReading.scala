...
class ArrayOfEnumsReading extends ArrayOfEnumsBenchmark {
  ...
  @Benchmark
  def circeJawn(): Array[SuitEnum] = io.circe.jawn.decodeByteArray[Array[SuitEnum]](jsonBytes).fold(throw _, identity)

  @Benchmark
  def circeJsoniter(): Array[SuitEnum] = {
    import com.github.plokhotnyuk.jsoniter_scala.benchmark.CirceJsoniterCodecs._

    Decoder[Array[SuitEnum]].decodeJson(readFromArray[io.circe.Json](jsonBytes)).fold(throw _, identity)
  }
  ...
  def playJsonJsoniter(): Array[SuitEnum] = {
    ...
    readFromArray[play.api.libs.json.JsValue](jsonBytes).as[Array[SuitEnum]]
  }
