...
abstract class GeoJSONBenchmark extends CommonParams {
  ...
  var jsonBytes: Array[Byte] = bytes(Utils.getResourceAsStream("che-1.geo.json"))
  ...
  var jsonString2: String = new String(bytes(Utils.getResourceAsStream("che-2.geo.json")), UTF_8)
  var jsonString3: String = new String(bytes(Utils.getResourceAsStream("che-3.geo.json")), UTF_8)
  var jsonString4: String = new String(bytes(Utils.getResourceAsStream("che-4.geo.json")), UTF_8)
}