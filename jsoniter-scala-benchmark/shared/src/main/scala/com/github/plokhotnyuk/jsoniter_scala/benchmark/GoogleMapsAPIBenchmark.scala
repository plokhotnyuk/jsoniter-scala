...
abstract class GoogleMapsAPIBenchmark extends CommonParams {
  ...
  var jsonBytes1: Array[Byte] = bytes(Utils.getResourceAsStream("google_maps_api_response-1.json"))
  var jsonBytes2: Array[Byte] = bytes(Utils.getResourceAsStream("google_maps_api_response-2.json"))
  var compactJsonBytes: Array[Byte] = bytes(Utils.getResourceAsStream("google_maps_api_compact_response.json"))
