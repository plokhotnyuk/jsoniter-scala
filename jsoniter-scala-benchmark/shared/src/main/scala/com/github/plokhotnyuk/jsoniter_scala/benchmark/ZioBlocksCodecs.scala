...
object ZioBlocksCodecs {
  ...
  val arrayOfOffsetDateTimesCodec: JsonBinaryCodec[Array[OffsetDateTime]] =
    Schema.derived.derive(JsonBinaryCodecDeriver)
  ...
  val arraySeqOfBooleansCodec: JsonBinaryCodec[ArraySeq[Boolean]] =
    Schema[ArraySeq[Boolean]].derive(JsonBinaryCodecDeriver)
  ...
  val mapOfIntsToBooleansCodec: JsonBinaryCodec[Map[Int, Boolean]] =
    Schema[Map[Int, Boolean]].derive(JsonBinaryCodecDeriver)
