...
class ArrayOfLocalDateTimesBenchmark extends CommonParams {
  ...
  @Benchmark
  def readDslJsonScala(): Array[LocalDateTime] = dslJsonDecode[Array[LocalDateTime]](jsonBytes)
  ...
  @Benchmark
  def readSprayJson(): Array[LocalDateTime] = JsonParser(jsonBytes).convertTo[Array[LocalDateTime]]
  ...
  @Benchmark
  def writeDslJsonScala(): Array[Byte] = dslJsonEncode[Array[LocalDateTime]](obj)
