...
class ArrayOfOffsetDateTimesBenchmark extends CommonParams {
  ...
  @Benchmark
  def readDslJsonScala(): Array[OffsetDateTime] = dslJsonDecode[Array[OffsetDateTime]](jsonBytes)
  ...
  @Benchmark
  def readSprayJson(): Array[OffsetDateTime] = JsonParser(jsonBytes).convertTo[Array[OffsetDateTime]]
  ...
  @Benchmark
  def writeDslJsonScala(): Array[Byte] = dslJsonEncode[Array[OffsetDateTime]](obj)
