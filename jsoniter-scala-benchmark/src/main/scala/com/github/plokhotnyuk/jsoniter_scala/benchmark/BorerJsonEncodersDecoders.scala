...
object BorerJsonEncodersDecoders {
  ...
  implicit val Codec(anyValsEnc: Encoder[AnyVals], anyValsDec: Decoder[AnyVals]) = {
    implicit val c1: Codec[ByteVal] = ArrayBasedCodecs.deriveCodecForUnaryCaseClass
    implicit val c2: Codec[ShortVal] = ArrayBasedCodecs.deriveCodecForUnaryCaseClass
    implicit val c3: Codec[IntVal] = ArrayBasedCodecs.deriveCodecForUnaryCaseClass
    implicit val c4: Codec[LongVal] = ArrayBasedCodecs.deriveCodecForUnaryCaseClass
    implicit val c5: Codec[BooleanVal] = ArrayBasedCodecs.deriveCodecForUnaryCaseClass
    implicit val c6: Codec[CharVal] = ArrayBasedCodecs.deriveCodecForUnaryCaseClass
    implicit val c7: Codec[DoubleVal] = ArrayBasedCodecs.deriveCodecForUnaryCaseClass
    implicit val c8: Codec[FloatVal] = ArrayBasedCodecs.deriveCodecForUnaryCaseClass
    deriveCodec[AnyVals]
  }
