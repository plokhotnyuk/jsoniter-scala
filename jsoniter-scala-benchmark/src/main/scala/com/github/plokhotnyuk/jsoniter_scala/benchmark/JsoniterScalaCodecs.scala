...
object JsoniterScalaCodecs {
  ...
  implicit val intMapOfBooleansCodec: JsonValueCodec[IntMap[Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-system*/))
  implicit val googleMapsAPICodec: JsonValueCodec[DistanceMatrix] = make(CodecMakerConfig())
  implicit val mapOfIntsToBooleansCodec: JsonValueCodec[Map[Int, Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-system*/))
  ...
  implicit val mutableLongMapOfBooleansCodec: JsonValueCodec[mutable.LongMap[Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-system*/))
  implicit val mutableMapOfIntsToBooleansCodec: JsonValueCodec[mutable.Map[Int, Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-system*/))
  implicit val mutableSetOfIntsCodec: JsonValueCodec[mutable.Set[Int]] = make(CodecMakerConfig(setMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-system*/))
  implicit val openHashMapOfIntsToBooleansCodec: JsonValueCodec[mutable.OpenHashMap[Int, Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-system*/))
