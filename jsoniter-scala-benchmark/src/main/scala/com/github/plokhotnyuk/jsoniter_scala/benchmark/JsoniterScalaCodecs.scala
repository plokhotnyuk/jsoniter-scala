...
object JsoniterScalaCodecs {
  ...
  val bigIntCodec: JsonValueCodec[BigInt] = make(CodecMakerConfig(bigIntDigitsLimit = Int.MaxValue)) /*WARNING: don't do this for open-systems*/
  ...
  implicit val adtCodec: JsonValueCodec[ADTBase] = make(CodecMakerConfig(allowRecursiveTypes = true /*WARNING: don't do this for open-systems*/))
  ...
  implicit val geoJSONCodec: JsonValueCodec[GeoJSON] = make(CodecMakerConfig(allowRecursiveTypes = true /*WARNING: don't do this for open-systems*/))
  ...
  implicit val nestedStructsCodec: JsonValueCodec[NestedStructs] = make(CodecMakerConfig(allowRecursiveTypes = true /*WARNING: don't do this for open-systems*/))
  ...
  implicit val bitSetCodec: JsonValueCodec[BitSet] = make(CodecMakerConfig(bitSetValueLimit = Int.MaxValue /*WARNING: don't do this for open-systems*/))
  implicit val extractFieldsCodec: JsonValueCodec[ExtractFields] = make(CodecMakerConfig())
  implicit val intMapOfBooleansCodec: JsonValueCodec[IntMap[Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-systems*/))
  implicit val googleMapsAPICodec: JsonValueCodec[DistanceMatrix] = make(CodecMakerConfig())
  implicit val mapOfIntsToBooleansCodec: JsonValueCodec[Map[Int, Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-systems*/))
  implicit val missingReqFieldCodec: JsonValueCodec[MissingReqFields] = make(CodecMakerConfig())
  implicit val mutableBitSetCodec: JsonValueCodec[mutable.BitSet] = make(CodecMakerConfig(bitSetValueLimit = Int.MaxValue /*WARNING: don't do this for open-systems*/))
  implicit val mutableLongMapOfBooleansCodec: JsonValueCodec[mutable.LongMap[Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-systems*/))
  implicit val mutableMapOfIntsToBooleansCodec: JsonValueCodec[mutable.Map[Int, Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-systems*/))
  implicit val mutableSetOfIntsCodec: JsonValueCodec[mutable.Set[Int]] = make(CodecMakerConfig(setMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-systems*/))
  implicit val openHashMapOfIntsToBooleansCodec: JsonValueCodec[mutable.OpenHashMap[Int, Boolean]] = make(CodecMakerConfig(mapMaxInsertNumber = Int.MaxValue /*WARNING: don't do this for open-systems*/))
