...
class JsonReaderSpec extends WordSpec with Matchers with ScalaCheckPropertyChecks {
  ...
  "JsonReader.readFloat, JsonReader.readKeyAsFloat and JsonReader.readStringAsFloat" should {
    ...
    "parse infinities on float overflow" in {
      ...
      check("123456789012345678901234567890e2147483639", Float.PositiveInfinity)
      check("-123456789012345678901234567890e2147483639", Float.NegativeInfinity)
    ...
    "parse zeroes on float underflow" in {
      ...
      check("-12345e-6789", -0.0f)
      check("0.12345678901234567890e-2147483639", 0.0f)
      check("-0.12345678901234567890e-2147483639", -0.0f)
  ...
  "JsonReader.readDouble, JsonReader.readKeyAsDouble and JsonReader.readStringAsDouble" should {
    ...
    "parse infinities on double overflow" in {
      ...
      check("12345678901234567890e2147483647", Double.PositiveInfinity)
      check("-12345678901234567890e2147483647", Double.NegativeInfinity)
    ...
    "parse zeroes on double underflow" in {
      ...
      check("-12345e-6789", -0.0)
      check("0.12345678901234567890e-2147483647", 0.0)
      check("-0.12345678901234567890e-2147483647", -0.0)
