...
sudo sysctl kernel.perf_event_paranoid=1
scala-cli --power package --native-version 0.5.12
...
```sh
scala-cli --power package --native-version 0.5.12 --native example02.sc --native-mode release-full --native-gc none --native-lto thin --native-multithreading=false --force -o example02_native.bin
...
```sh
scala-cli --power package --native-version 0.5.12 --native example03.scala --native-mode release-full --native-gc none --native-lto thin --native-multithreading=false --force -o example03_native.bin
